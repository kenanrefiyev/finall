    ...
    <div className='bg-white mt-2 px-4 md:px-16 lg:px-24'>
      <div className='container mx-auto py-4 flex flex-col md:flex-row space-x-2'>
        <div className='w-full md:w-3/12'>
          <div className='bg-red-600 text-white text-xl font-bold px-2 py-2.5'>Shop By Categories</div>
        ...
        <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'>
          ...
          <div className='absolute top-16 left-8'>
            <h2 className='text-3xl font-bold'>Welcome to st-Shop</h2>
            <p className='text-xl mt-2.5 font-bold text-gray-800'>Millons+ Products</p>
