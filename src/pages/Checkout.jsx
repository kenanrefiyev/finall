                    ...
                    <div className='border p-2 mb-6'>
                        ...
                        <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
                            <div>
                                ...
                                <input type="text" name='name' placeholder='Enter your address' className='w-full px-3 py-2 border' onChange={(e) => setShippinInfo({ ...shippinhInfo, address: e.target.value })} />
                            </div>
                        </div>
                        <div>
                            <div>
                        ...
                        {paymentMethod === 'dc' && (
                            <div className='bg-gray-100 p-4 rounded-lg mb-4'>
                                ...
                                <div className='mb-4'>
                                    ...
                                    <input
                                        type="text" placeholder='Enter card number' className='border p-2 w-full rounded'
                                        maxLength={16}
                                        required
                                        onChange={(e) => {
                        ...
                        {cart.products.map(product => (
                            <div key={product.id} className='flex justify-between'>
                                <div className='flex items-center'>
                                    <img src={product.image} alt={product.name} className='w-16 h-16 onbejct-contain rounded' />
                                    <div className='ml-4'>
